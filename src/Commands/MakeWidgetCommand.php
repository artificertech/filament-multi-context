...
class MakeWidgetCommand extends \Filament\Commands\MakeWidgetCommand
{
    use ContextAwareCommand;

    protected $signature = 'make:filament-widget {name?} {--R|resource=} {--C|chart} {--T|table} {--S|stats-overview} {--F|force} {--context=}';
